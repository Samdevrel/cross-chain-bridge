      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Seamlessly transfer assets between different blockchain networks with low fees and high security.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            ...
            <li>Bridge assets with automatic bridge selection</li>
            <li>Real-time bridge comparison and optimization</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ Real-time bridge status and fees</li>
            <li>✓ Security audited bridges only</li>
            <li>✓ Auto-conversion at optimal rates</li>
            <li>✓ Transaction tracking and status</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Choose optimal bridge for lowest fees</li>
          </ol>
        </section>
